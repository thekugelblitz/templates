    ...
    <ul>
        ...
        <li class="menu-right">
            ...
            {/if}"></i>
                ...
                <li class="has-dropdown icon-dropdown">
                    <a id="Menu-DarkModeToggle" href="#" onclick="toggleDarkMode(); return false;" class="nav-icon-btn" title="Toggle Dark Mode">
                        <i class="ph ph-moon" id="darkModeIcon"></i>
                    </a>
                </li>
                <li class="has-dropdown icon-dropdown" data-dropdown>
...
<script>
// HSPL WHMCS Redesigned - Dark Mode Logic
function toggleDarkMode() {
    ...
    localStorage.setItem('hspl_admin_theme', newTheme);
